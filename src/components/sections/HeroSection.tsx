    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background px-4 pt-20 pb-16">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
          A full-day hands-on bootcamp where you'll go from idea to working app using <a href="https://lovable.dev" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle"><img src={lovableLogo} alt="Lovable.dev" className="h-10 sm:h-12 inline-block" /></a> — the platform that turns natural language into functional code. No coding experience required.
        </p>
