    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background px-4 pt-28 pb-8">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="w-full max-w-3xl mx-auto text-center">
          {activeTab === "you" ? (
            <div className="relative flex flex-col items-center p-6 rounded-3xl border-2 border-purple/20 bg-card shadow-xl shadow-purple/5 transition-transform hover:-translate-y-1">
              <div className="mb-6">
