  ...
  return (
    <section id="hosts" className="py-20 px-4 bg-section-alt">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="font-display text-3xl sm:text-4xl font-bold mb-4">Your Vibe Coding Specialists. The number of hosts present during the workshop depends on the number of participants. 
          <span className="gradient-text">Workshop Hosts</span>
        </h2>
