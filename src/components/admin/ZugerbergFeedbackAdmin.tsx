...
const KIND = "zugerberg_feedback";
const SURVEY_PATH = "/zugerberg-feedback";
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="flex items-center gap-2">
            <Link2 className="w-5 h-5" /> Zugerberg Feedback Link
          </CardTitle>
          {!feedbackLink && (
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button
            ...
            onClick={() => exportToXlsx(responses, "zugerberg-feedback", "Zugerberg Feedback")}
          >
...
export default ZugerbergFeedbackAdmin;