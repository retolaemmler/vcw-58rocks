...
const KIND = "raiffeisen_feedback";
const SURVEY_PATH = "/raiffeisen-feedback";
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="flex items-center gap-2">
            <Link2 className="w-5 h-5" /> Raiffeisen Feedback Link
          </CardTitle>
          {!feedbackLink && (
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button
            ...
            onClick={() => exportToXlsx(responses, "raiffeisen-feedback", "Raiffeisen Feedback")}
          >
...
export default RaiffeisenFeedbackAdmin;