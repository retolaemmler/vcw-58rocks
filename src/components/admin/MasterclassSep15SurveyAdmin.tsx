...
const KIND = "mc_sep15_prep";
const SURVEY_PATH = "/mc-sep15-prep";

const MasterclassSep15SurveyAdmin = () => {
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="flex items-center gap-2">
            <Link2 className="w-5 h-5" /> 15.09.26 Masterclass Prep Survey Link
          </CardTitle>
          {!surveyLink && (
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button
            ...
            onClick={() => exportToXlsx(responses, "mc-sep15-prep-survey", "15.09.26 Masterclass Prep Survey")}
          >
...
export default MasterclassSep15SurveyAdmin;