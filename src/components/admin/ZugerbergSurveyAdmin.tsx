...
const SURVEY_PATH = "/zugerberg-prep";

const ZugerbergSurveyAdmin = () => {
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="flex items-center gap-2">
            <Link2 className="w-5 h-5" /> Zugerberg Prep Survey Link
          </CardTitle>
          {!surveyLink && (
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button
            ...
            onClick={() => exportToXlsx(responses, "zugerberg-prep-survey", "Zugerberg Prep Survey")}
          >
...
export default ZugerbergSurveyAdmin;