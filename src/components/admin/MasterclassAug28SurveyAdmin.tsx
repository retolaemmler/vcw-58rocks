...
const KIND = "mc_aug28_prep";
const SURVEY_PATH = "/mc-aug28-prep";

const MasterclassAug28SurveyAdmin = () => {
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="flex items-center gap-2">
            <Link2 className="w-5 h-5" /> 28.08.26 Masterclass Prep Survey Link
          </CardTitle>
          {!surveyLink && (
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button
            ...
            onClick={() => exportToXlsx(responses, "mc-aug28-prep-survey", "28.08.26 Masterclass Prep Survey")}
          >
...
export default MasterclassAug28SurveyAdmin;