...
const KIND = "masterclass_hsg_aug26_prep";
const SURVEY_PATH = "/hsg-alumni-aug26-prep";

const MasterclassHsgAug26SurveyAdmin = () => {
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="flex items-center gap-2">
            <Link2 className="w-5 h-5" /> 26.8.26 HSG Alumni Masterclass Prep Survey Link
          </CardTitle>
        </CardHeader>
        {surveyLink && (
          <CardContent>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button
            ...
            onClick={() => exportToXlsx(responses, "hsg-aug26-survey", "26.8.26 HSG Alumni Masterclass Prep Survey")}
          >
...
export default MasterclassHsgAug26SurveyAdmin;