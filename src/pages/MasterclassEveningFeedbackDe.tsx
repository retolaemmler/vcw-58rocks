...
const AGENDA_SECTIONS: { key: keyof FeedbackFormValues; label: string }[] = [
  ...
  { key: "rating_lunch", label: "🍕 Pizza-Pause" },
    ...
    <div className="min-h-screen bg-background py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="font-display text-xl font-semibold">Wie war dein Abend? 💬</h2>
          <p className="text-muted-foreground mt-2">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-16">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-base">💎 Was war dein Highlight des Abends?</FormLabel>
                        <FormControl>
...
export default MasterclassEveningFeedbackDe;
