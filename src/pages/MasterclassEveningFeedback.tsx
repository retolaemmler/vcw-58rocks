    ...
    <div className="min-h-screen bg-background py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="font-display text-xl font-semibold">How was your evening? 💬</h2>
          <p className="text-muted-foreground mt-2">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-16">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-base">💎 What was your highlight of the evening?</FormLabel>
                        <FormControl>
...
export default MasterclassEveningFeedback;
