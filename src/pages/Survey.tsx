...
const BUILDING_BLOCK_CHIPS = ["Email", "Payments (e.g. Stripe)", "User login", "CRM", "Bexio", "Database / storage", "File uploads", "Maps / location", "Calendar", "Analytics", "API integrations", "AI features"];
