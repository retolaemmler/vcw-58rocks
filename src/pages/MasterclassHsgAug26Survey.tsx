...
const DEFAULT_TOKEN = "hsg-aug26-masterclass-prep";

const MasterclassHsgAug26Survey = () => {
  ...
  useEffect(() => {
    ...
    supabase.rpc("validate_survey_token", { _token: token })
      .then(({ data }) => {
        ...
        if (row && row.kind === "masterclass_hsg_aug26_prep") { setTokenId(row.id); setPageState("form"); }
        ...
        <Card className="w-full max-w-md text-center">
          <CardHeader>
            ...
            <p className="text-muted-foreground mt-2">
              Vielen Dank, dass du dir die Zeit genommen hast — wir nutzen deine Antworten, um die Masterclass für dich grossartig zu machen. Bis am 26. August!
            </p>
          </CardHeader>
        </Card>
      </div>
...
export default MasterclassHsgAug26Survey;