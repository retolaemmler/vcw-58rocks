const de = {
  banner: {
    text: "Kannst du nicht am nächsten Workshop teilnehmen? Komm zum Vibe Code Fest am 24. Oktober in Basel",
    cta: "→",
  ...
  hero: {
    ...
    subtitle: "Baue eine Web-App an einem Abend",
    ...
    company: {
      ...
      topic2: "Vor Ort oder remote",
      topic3: "2-3 Coaches, je nach Teamgrösse",
      topic4: "An deinem Wunschtermin, Startzeit und Dauer",
  ...
  audience: {
    ...
    industryAgnostic: "\"Wir sind branchenunabhängig. Wir haben Workshops in verschiedenen Branchen durchgeführt.\"",
    items: {
