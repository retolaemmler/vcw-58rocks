const en = {
  banner: {
    text: "Join us in Basel for Vibe Code Fest on Oct. 24",
    cta: "→",
  ...
  hero: {
    ...
    subtitle: "Build a Web App in One Evening",
    descriptionBefore: "A half-/full-day hands-on workshop where you'll go from idea to working web app using ",
    ...
    company: {
      ...
      topic2: "On-site or remote",
      topic3: "2-3 coaches, depending on the team size",
      topic4: "On your preferred date, start time and duration",
      cta: "Get in touch",
  ...
  pricing: {
    ...
    tiers: {
      ...
      regular: { name: "Regular", discount: "13% off" },
